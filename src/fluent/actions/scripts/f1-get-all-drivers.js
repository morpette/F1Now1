/**
 * Thin invoker for F1 API REST function `getAllDrivers` (GET /api/drivers).
 * All HTTP detail lives in the 'F1 API Driver Endpoints' REST Message; this step only wires
 * inputs to ${vars} and surfaces the raw response as action outputs.
 */
(function execute(inputs, outputs) {
    try {
        var rm = new sn_ws.RESTMessageV2('F1 API Driver Endpoints', 'getAllDrivers');
