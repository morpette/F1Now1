/**
 * Thin invoker for F1 API REST function `searchDrivers`
 * (GET /api/drivers/search?q=...).
 */
(function execute(inputs, outputs) {
    try {
        var rm = new sn_ws.RESTMessageV2('F1 API Driver Endpoints', 'searchDrivers');
        rm.setStringParameterNoEscape('q', String(inputs.query));
