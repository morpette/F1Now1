/**
 * Thin invoker for F1 API REST function `getTeamDriversBySeason`
 * (GET /api/{year}/teams/{teamId}/drivers).
 */
(function execute(inputs, outputs) {
    try {
        var rm = new sn_ws.RESTMessageV2('F1 API Driver Endpoints', 'getTeamDriversBySeason');
