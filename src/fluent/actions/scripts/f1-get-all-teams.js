/**
 * Thin invoker for F1 API REST function `getAllTeams` (GET /api/teams).
 * All HTTP detail lives in the 'F1 API Team Endpoints' REST Message; this step only wires
 * inputs to ${vars} and surfaces the raw response as action outputs.
 */
(function execute(inputs, outputs) {
    try {
        var rm = new sn_ws.RESTMessageV2('F1 API Team Endpoints', 'getAllTeams');
