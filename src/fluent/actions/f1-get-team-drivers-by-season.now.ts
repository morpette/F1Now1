...
export const f1GetTeamDriversBySeason = Action(
    {
        ...
        masterSnapshot: '62535b78937dcf14a03577f08bba10e7',
    },
    (params) => {
        const invoke_f1_api_getteamdriversbyseason = wfa.actionStep(
            actionStep.script,
        ...
        wfa.assignActionOutputs(params.outputs, {
            response_body: wfa.dataPill(invoke_f1_api_getteamdriversbyseason.response_body, 'string'),
            status_code: wfa.dataPill(invoke_f1_api_getteamdriversbyseason.status_code, 'integer'),
            error_message: wfa.dataPill(invoke_f1_api_getteamdriversbyseason.error_message, 'string'),
        })
    }
)
