/**
 * ATF server-side script — invokes the "F1: Get Driver by ID" action via the
...
(function () {
    ...
    var result = sn_fd.FlowAPI.getRunner()
        ...
        .inForeground()
        .withInputs({ driver_id: 'max_verstappen' })
        .run();
    ...
    stepResult.setOutputMessage('OK: 200, valid JSON, "driver" present (total=' + parsed.total + ')');
})();