/**
 * ATF server-side script — invokes the "F1: Get Driver Season Results" action
...
(function () {
    ...
    var result = sn_fd.FlowAPI.getRunner()
        .action('x_1912467_f1now1.f1_get_driver_season_results')
        .inForeground()
        .withInputs({ year: 2024, driver_id: 'max_verstappen', limit: 5, offset: 0 })
        .run();
