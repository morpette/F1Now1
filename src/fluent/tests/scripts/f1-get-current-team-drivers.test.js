/**
 * ATF server-side script — invokes the "F1: Get Current Season Team Drivers"
 * action via the scriptable Flow runner and asserts a 200 JSON response
 * containing a top-level "drivers" element.
 */
(function () {
    function fail(msg) {
    ...
    var result = sn_fd.FlowAPI.getRunner()
        .action('x_1912467_f1now1.f1_get_current_team_drivers')
        .inForeground()
        .withInputs({ team_id: 'red_bull', limit: 5, offset: 0 })
        .run();
